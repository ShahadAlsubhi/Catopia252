 ...
 * @author user
 */
public class SingleCat implements Cat {
   ...
   // public static ArrayList<Cat> cats;
    ...
    public SingleCat(int catId, String ownerId, String catName, String sex, int age, String breed, SingleCat bound, String behavior, boolean disabled, String medicalHistory, boolean likesCats, boolean likesChildrens, String adoptionState, String adoptionReason, ArrayList<String> adoptionUpdates, int adoptionFees) {
        this.catId = catId;
